...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            // Ads
            self.showViewController(viewController: UINavigationController.self, storyboardId: "AdsNavID")
        case 2:
            // Multiple
            self.showViewController(viewController: UINavigationController.self, storyboardId: "MultipleNavID")
        case 3:
            // Table
            self.showViewController(viewController: UINavigationController.self, storyboardId: "TableNavID")
        case 4:
            // Scroll
            self.showViewController(viewController: UINavigationController.self, storyboardId: "ScrollNavID")
        case 5:
            // Collection
            self.showViewController(viewController: UINavigationController.self, storyboardId: "CollectionNavID")
        case 6:
            // Data Collection
