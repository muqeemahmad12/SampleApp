 ...
 */
@interface OMIDDocereeAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDDocereeAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDDocereeVASTProperties *_Nonnull)vastProperties
