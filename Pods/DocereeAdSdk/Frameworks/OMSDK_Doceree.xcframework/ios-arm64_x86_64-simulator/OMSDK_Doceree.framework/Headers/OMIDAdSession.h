 ...
 */
@interface OMIDDocereeAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDDocereeAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDDocereeAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDDocereeAdSessionContext *)context
