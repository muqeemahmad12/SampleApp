 ...
 */
@interface OMIDDocereeAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDDocereePartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDDocereePartner *)partner
                               ...
                               resources:(NSArray<OMIDDocereeVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
